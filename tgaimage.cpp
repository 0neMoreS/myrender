...
bool TGAImage::read_tga_file(const char *filename)
{
    ...
    {
        in.close();
        std::cout << "bad bpp (or width/height) value\n";
        return false;
    }
    ...
    {
        in.close();
        std::cout << "unknown file format " << (int)header.datatypecode << "\n";
        return false;
    }
    ...
    std::cout << width << "x" << height << "/" << bytespp * 8 << "\n";
    in.close();
    return true;
}
...
bool TGAImage::write_tga_file(const char *filename, bool rle)
{
    ...
    if (!rle)
    {
        ...
        if (!out.good())
        {
            std::cout << "can't unload raw data\n";
            out.close();
            return false;
        }
    }
    else
    {
        ...
        {
            out.close();
            std::cout << "can't unload rle data\n";
            return false;
        }
    }
